    ...
    return(
            ...
            <div className="container px-5 py-24 mx-auto flex flex-col ">
                ...
                <div className="flex flex-col sm:flex-row mt-10">
                    ...
                    <p className="leading-relaxed text-lg mb-4 fw font-light text-white"> I am a passionate software developer with a strong foundation in programming and problem-solving. With experience in web development, databases, and version control, I aim to inspire and connect with fellow software enthusiasts through my personal website. <br/> Join me on this journey as we explore the exciting world of software development together. Through sharing my knowledge and experiences, I hope to make a positive impact and contribute to the ever-evolving field of technology. <br/> Let's collaborate, learn, and create innovative solutions that shape the future of software development. </p>
