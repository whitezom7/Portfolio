                ...
                <div className="lg:w-4/6 mx-auto">
                    <div className="flex flex-col sm:flex-row mt-10">
                        <div className="sm:w-1/3 text-center sm:pr-8 sm:py-8">
                            <div
                                className=" rounded-full inline-flex items-center justify-center bg-gray-200 text-black">
                                <Image width={115} height={140} style={imageStyle}
                                       src="https://avatars.githubusercontent.com/u/72764274?s=400&u=ab7c2922b9b0a6462f8939123dce237c0254073a&v=4"
                                       alt="image description"/>
                            </div>
                            <div className="flex flex-col items-center text-center justify-center">
                                <h2 className="font-medium title-font mt-4 text-white text-lg">Taylor Whitewood</h2>
                                <div className="w-12 h-1 bg-indigo-500 rounded mt-2 mb-4"></div>
                                <p className="text-base text-white">Versatile IT professional interested in Web
                                    Development, Cyber Security, System Administrating and Game Development.</p>
                            </div>
                        </div>
                        <div
